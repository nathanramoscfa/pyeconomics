...
def balanced_approach_rule(
    ...
    """
    Generate an AI-based analysis of the Balanced Approach Rule calculation
    results.

    Args:
        data (dict): Dictionary containing the Balanced Approach Rule
            calculation data.
    ...
    prompt = prompt_template.format(
        ...
        unadjusted_balanced_approach_rule=round(data['unadjusted_rate'], 2),
        adjusted_balanced_approach_rule_after_elb=round(
            data['adjusted_rate_after_elb'], 2),
        adjusted_balanced_approach_rule_after_inertia=round(
            data['adjusted_rate_after_inertia'], 2)
    )
