# pyeconomics/ai/first_difference_rule.py
...
def first_difference_rule(
    ...
    prompt = prompt_template.format(
        ...
        lagged_unemployment_rate=round(data['lagged_unemployment_rate'], 2),
        natural_unemployment_rate=round(data['natural_unemployment_rate'], 2),
        lagged_natural_unemployment_rate=round(
            data['lagged_natural_unemployment_rate'], 2),
        current_fed_rate=round(data['current_fed_rate'], 2),
        inflation_gap=round(data['inflation_gap'], 2),
        current_unemployment_gap=round(data['current_unemployment_gap'], 2),
        unadjusted_fdr_rule=round(
            data['unadjusted_fdr_rule'], 2),
        adjusted_fdr_rule_after_elb=round(
            data['adjusted_fdr_rule_after_elb'], 2),
        adjusted_fdr_rule_after_inertia=round(
            data['adjusted_fdr_rule_after_inertia'], 2)
    )
